...
def plot_figure_7(inputs, outputs, threads, config, params, wildcards):
    ...
    C_cal_rgb = C_cal_geo.pauli_image(k=0.2, sf=0.2, common=False)
    ...
    ax.scatter(C_cal_geo.shape[0] - np.imag(ref_gc), np.real(ref_gc), edgecolors=marker_color, s=20, facecolors='none')
