...
\begin{table*}
	...
	\pgfplotstabletypeset[
		...
		Bandwidth & 200 MHz\\
		Range resolution& 0.95 m 3dB resolution @ -26 dB peak sidelobe\\
		Azimuth pattern beamwidth& $\mathrm{0.385^\circ}$ 3dB beamwidth\\
		Elevation pattern beamwidth& $\mathrm{35^\circ}$ 3dB beamwidth\\
