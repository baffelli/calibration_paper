...
\begin{figure*}[h]
	\begin{subfigure}[b]{0.6\columnwidth}
		\centering
		\includegraphics[scale=0.7]{2014-2016_GPRI_HIL_Calibration_20140910_144113_810_8046_AAAl_chan_mph_plot}
		\subcaption{HH channel without beam squint correction.}
		\label{fig:tcr_mph:HH_uncorr}
	\end{subfigure}~
	\begin{subfigure}[b]{0.6\columnwidth}
		\centering
		\includegraphics[scale=0.7]{2014-2016_GPRI_HIL_Calibration_20140910_144113_810_8046_AAAl_desq_mph_plot}
		\subcaption{HH channel with squint correction.}
		\label{fig:tcr_mph:HH_corr}
	\end{subfigure}~
	\begin{subfigure}[b]{0.6\columnwidth}
		\centering
		\includegraphics[scale=0.7]{2014-2016_GPRI_HIL_Calibration_20140910_144113_810_8046_AAAl_corr_mph_plot}
		\subcaption{HH channel with squint and azimuth ramp correction.}
		\label{fig:tcr_mph:HH_corr_ph}
	\end{subfigure}\\
	\begin{subfigure}[b]{0.6\columnwidth}
		\centering
		\includegraphics[scale=0.7]{2014-2016_GPRI_HIL_Calibration_20140910_144113_810_8046_BBBl_chan_mph_plot}
		\subcaption{VV channel without beam squint correction.}
		\label{fig:tcr_mph:VV_uncorr}
	\end{subfigure}~
	\begin{subfigure}[b]{0.6\columnwidth}
		\centering
		\includegraphics[scale=0.7]{2014-2016_GPRI_HIL_Calibration_20140910_144113_810_8046_BBBl_desq_mph_plot}
		\subcaption{VV channel with squint correction.}
		\label{fig:tcr_mph:VV_corr}
	\end{subfigure}~
	\begin{subfigure}[b]{0.6\columnwidth}
		\centering
		\includegraphics[scale=0.7]{2014-2016_GPRI_HIL_Calibration_20140910_144113_810_8046_BBBl_corr_mph_plot}
...
\begin{figure}[ht]
	\begin{subfigure}[t]{\columnwidth}
		\includegraphics{2014-2016_GPRI_HIL_Calibration_20140910_144113_BBBl_coreg_phase_plot}
		\subcaption{Azimuth phase ramp not corrected.}
	\end{subfigure}
	\begin{subfigure}[t]{\columnwidth}
		\includegraphics{2014-2016_GPRI_HIL_Calibration_20140910_144113_BBBl_corr_phase_plot}
...
\begin{figure}[ht]
	\begin{subfigure}[t]{\columnwidth}
		\includegraphics{2014-2016_GPRI_HIL_Calibration_20140910_144113_l_cal_gc_pauli}
		\subcaption{Calibrated Pauli RGB Composite.}
		\label{fig:gc:pauli_rgb}
	\end{subfigure}
	\begin{subfigure}[t]{\columnwidth}
		\includegraphics{2014-2016_GPRI_HIL_Calibration_20140910_144113_l_cal_gc_alpha}
...
\pgfplotstableread[col sep=comma]{../outputs/img/2014-2016_GPRI_HIL_Calibration_20140910_144113_76_883_l_cal_cal_params.csv}{\refI}
\pgfplotstableread[col sep=comma]{../outputs/img/2014-2016_GPRI_HIL_Calibration_20140910_144113_197_410_l_cal_cal_params.csv}{\refII}
\pgfplotstableread[col sep=comma]{../outputs/img/2014-2016_GPRI_HIL_Calibration_20140910_144113_332_737_l_cal_cal_params.csv}{\refIII}
\pgfplotstableread[col sep=comma]{../outputs/img/2014-2016_GPRI_HIL_Calibration_20140910_144113_810_804_l_cal_cal_params.csv}{\refIV}
...
\begin{figure*}[hb]
		\begin{subfigure}[t]{\columnwidth}
		\centering
			\signatures{2014-2016_GPRI_HIL_Calibration_20140910_144113_76_883_l}
		...
		\begin{subfigure}[t]{\columnwidth}
			\centering
			\signatures{2014-2016_GPRI_HIL_Calibration_20140910_144113_197_410_l}
		...
		\begin{subfigure}[t]{\columnwidth}
			\centering
			\signatures{2014-2016_GPRI_HIL_Calibration_20140910_144113_332_737_l}
		...
		\begin{subfigure}[t]{\columnwidth}
			\centering
			\signatures{2014-2016_GPRI_HIL_Calibration_20140910_144113_810_804_l}
