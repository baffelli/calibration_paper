...
\pgfplotstableset{rph style/.style={,
									...
									display columns/0/.style={precision=3, column name={$L_{ph}$}},
									display columns/1/.style={precision=3, column name={residual}},
									display columns/2/.style={precision=3, column name={$R_0$}}
									},
									}
...
The result of applying the correction to the TCR at 673 m is displayed in the rightmost column of \autoref{fig:tcr_mph}; the phase ramp is significantly reduced while the azimuth resolution is slightly degraded.\\
...
%\def\refI{../outputs/img/\chutzepref_32_519_l}
%\def\refII{../outputs/img/\chutzepref_1032_570_l}
%\def\refIII{../outputs/img/\chutzepref_1051_561_l}
%\def\refIV{../outputs/img/\chutzepref_1331_149_l}
%\def\refV{../outputs/img/\chutzepref_3518_354_l}
%
%\pgfplotstableread[col sep=comma]{\refI_cal_cal_params.csv}{\refIt}
%\pgfplotstableread[col sep=comma]{\refII_cal_cal_params.csv}{\refIIt}
%\pgfplotstableread[col sep=comma]{\refIII_cal_cal_params.csv}{\refIIIt}
%\pgfplotstableread[col sep=comma]{\refIV_cal_cal_params.csv}{\refIVt}
%\pgfplotstableread[col sep=comma]{\refV_cal_cal_params.csv}{\refVt}
...
%							\node[right  =  -0.0cm  of copoluncal] (xpoluncal) {\includegraphics{#1_flat_signature_x}};
%							\node[below = 1.5 cm of copoluncal] (copolcal) at (0,0){\includegraphics{#1_cal_signature}};
%							\node[right  = 0.0cm of copolcal] (xpolcal) {\includegraphics{#1_cal_signature_x}};
...
%					}
%
%\newcommand\sigsubfig[1]{
%			\begin{subfigure}[t]{0.5\linewidth}
%				\begin{subfigure}[t]{0.5\linewidth}
%					\includegraphics{#1_flat_signature}
%				\end{subfigure}~
%				\begin{subfigure}[t]{0.5\linewidth}
%					\includegraphics{#1_flat_signature_x}
%				\end{subfigure}\\
%				\begin{subfigure}[t]{0.5\linewidth}
%					\includegraphics{#1_cal_signature}
%				\end{subfigure}~
%				\begin{subfigure}[t]{0.5\linewidth}
%					\includegraphics{#1_cal_signature_x}
%				\end{subfigure}
%			\end{subfigure}}
