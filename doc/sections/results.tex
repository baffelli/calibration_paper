...
\begin{table}[h]
	...
	\caption{Copolar phase and amplitude imbalance computed on the reflectors using the calibrated dataset. The polarization purity (VV/HV ratio) is shown additionally, alongside with the ratio of the measured to the predicted RCS.}
	\label{tab:polcal}
\end{table}		
