...
%	\end{subfigure}~
	...
	\caption{Oversampled phase and amplitude response for the trihedral corner reflector. Top row: HH channel, bottom row: VV channel, from left to right: no correction, squint compensation and azimuth ramp correction.}
	\label{fig:tcr_mph}
\end{figure*}
