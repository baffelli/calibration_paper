...
Panels (a) and (b) of \autoref{fig:scene_mph} show the effect of the processing described in \autoref{sec:proc_SLC}; in (a) the raw data is directly range compressed as is, while in (b) the frequency-squint compensation is applied to the data before range focusing.\\ 
